...
const ModalCrearTienda = ({ visible, onCancel, onSubmit, successColor , tiendasBolivia, setTiendasBolivia }) => {
    const { Option } = Select;
        ...
        <Button key="submit" type="primary" onClick={handleSubmit} style={{ backgroundColor: successColor, borderColor: successColor }}>Agregar </Button>,]}>
          ...
          <Form form={form} layout="vertical">
            <Row gutter={16}>
                ...
                <Col span={12}>
                    <Form.Item name="estado" label="Estado" rules={[{ required: true, message: 'Please input your name!' }]}>
  ...
  export default ModalCrearTienda;